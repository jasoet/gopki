...
func TestToP12KeyPairFunctions(t *testing.T) {
	...
	createCertificate := func(keyPair any) *x509.Certificate {
...
func TestFromP12KeyPairFunctions(t *testing.T) {
	...
	createSelfSignedCertificate := func(keyPair any) *x509.Certificate {
		template := &x509.Certificate{
			Subject: pkix.Name{
				CommonName:   "Test Certificate",
				Organization: []string{"Test Org"},
...
func TestImportFromP12KeyPairWithValidation(t *testing.T) {
	...
	// Helper function to create certificate
	createValidationCertificate := func(keyPair any) *x509.Certificate {
		template := &x509.Certificate{
			Subject: pkix.Name{
